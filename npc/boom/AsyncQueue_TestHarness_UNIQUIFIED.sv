...
module AsyncQueue_TestHarness_UNIQUIFIED(	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:226:7]
  ...
  AsyncQueueSource_Phit_TestHarness_UNIQUIFIED source(	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:228:70]
    .clock                        (io_enq_clock),
    .reset                        (io_enq_reset),
  ...
  AsyncQueueSink_Phit_TestHarness_UNIQUIFIED sink(	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:229:70]
    .clock                        (io_deq_clock),
    .reset                        (io_deq_reset),
