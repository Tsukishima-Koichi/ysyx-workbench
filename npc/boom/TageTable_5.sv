...
module TageTable_5(	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:24:7]
  ...
  wire [6:0]  _idx_history_T_7 = io_f1_req_ghist[6:0] ^ io_f1_req_ghist[13:7] ^ io_f1_req_ghist[20:14] ^ io_f1_req_ghist[27:21] ^ io_f1_req_ghist[34:28] ^ io_f1_req_ghist[41:35] ^ io_f1_req_ghist[48:42] ^ io_f1_req_ghist[55:49] ^ io_f1_req_ghist[62:56];	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:53:11, :55:25]
  wire [6:0]  s1_hashed_idx = io_f1_req_pc[9:3] ^ {_idx_history_T_7[6:1], _idx_history_T_7[0] ^ io_f1_req_ghist[63]};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:53:11, :55:25, :60:29, generators/boom/src/main/scala/v3/ifu/frontend.scala:162:35]
  ...
  wire [6:0]  _idx_history_T_15 = io_update_hist[6:0] ^ io_update_hist[13:7] ^ io_update_hist[20:14] ^ io_update_hist[27:21] ^ io_update_hist[34:28] ^ io_update_hist[41:35] ^ io_update_hist[48:42] ^ io_update_hist[55:49] ^ io_update_hist[62:56];	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:53:11, :55:25]
  wire [6:0]  update_idx = io_update_pc[9:3] ^ {_idx_history_T_15[6:1], _idx_history_T_15[0] ^ io_update_hist[63]};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:53:11, :55:25, :60:29, generators/boom/src/main/scala/v3/ifu/frontend.scala:162:35]
  wire [8:0]  _tag_history_T_11 = io_update_hist[8:0] ^ io_update_hist[17:9] ^ io_update_hist[26:18] ^ io_update_hist[35:27] ^ io_update_hist[44:36] ^ io_update_hist[53:45] ^ io_update_hist[62:54];	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:53:11, :55:25]
  wire [8:0]  update_tag = io_update_pc[18:10] ^ {_tag_history_T_11[8:1], _tag_history_T_11[0] ^ io_update_hist[63]};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:53:11, :55:25, :62:{30,50}, generators/boom/src/main/scala/v3/ifu/frontend.scala:162:35]
  assign table_MPORT_data_0 = doing_reset ? 13'h0 : {1'h1, update_tag, update_wdata_0_ctr};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:62:50, :72:28, :123:{8,29,102}, :155:33]
  assign table_MPORT_data_1 = doing_reset ? 13'h0 : {1'h1, update_tag, update_wdata_1_ctr};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:62:50, :72:28, :123:{8,29,102}, :155:33]
  assign table_MPORT_data_2 = doing_reset ? 13'h0 : {1'h1, update_tag, update_wdata_2_ctr};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:62:50, :72:28, :123:{8,29,102}, :155:33]
  assign table_MPORT_data_3 = doing_reset ? 13'h0 : {1'h1, update_tag, update_wdata_3_ctr};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:62:50, :72:28, :123:{8,29,102}, :155:33]
  ...
  wire [8:0]  _tag_history_T_5 = io_f1_req_ghist[8:0] ^ io_f1_req_ghist[17:9] ^ io_f1_req_ghist[26:18] ^ io_f1_req_ghist[35:27] ^ io_f1_req_ghist[44:36] ^ io_f1_req_ghist[53:45] ^ io_f1_req_ghist[62:54];	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:53:11, :55:25]
  ...
  always @(posedge clock) begin	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:24:7]
    ...
    s2_tag <= io_f1_req_pc[18:10] ^ {_tag_history_T_5[8:1], _tag_history_T_5[0] ^ io_f1_req_ghist[63]};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:53:11, :55:25, :62:{30,50}, :95:29, generators/boom/src/main/scala/v3/ifu/frontend.scala:162:35]
  ...
  hi_us_4 hi_us (	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:89:27]
  ...
  lo_us_4 lo_us (	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:90:27]
    .R0_addr (s1_hashed_idx),	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:60:29]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
  ...
  table_4 table_0 (	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:91:27]
    .R0_addr (s1_hashed_idx),	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:60:29]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
