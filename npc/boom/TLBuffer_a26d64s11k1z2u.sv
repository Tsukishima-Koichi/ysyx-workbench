...
module TLBuffer_a26d64s11k1z2u(	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9]
  ...
  output [10:0] auto_out_a_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  input  [10:0] auto_out_d_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  wire [10:0] _nodeIn_d_q_io_deq_bits_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  Queue1_TLBundleA_a26d64s11k1z2u nodeOut_a_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue1_TLBundleD_a26d64s11k1z2u nodeIn_d_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
