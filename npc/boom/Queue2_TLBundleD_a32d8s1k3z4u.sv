...
module Queue2_TLBundleD_a32d8s1k3z4u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  ram_2x10 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_denied, io_enq_bits_data, io_enq_bits_corrupt})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_denied = _ram_ext_R0_data[9];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
