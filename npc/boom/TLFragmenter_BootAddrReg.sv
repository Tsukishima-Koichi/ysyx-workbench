...
module TLFragmenter_BootAddrReg(	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
  ...
  wire [5:0]  _dsizeOH1_T = 6'h7 << auto_anon_out_d_bits_size;	// @[generators/rocket-chip/src/main/scala/util/package.scala:244:71]
  wire [2:0]  _GEN = ~(auto_anon_out_d_bits_source[2:0]);	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:204:41, generators/rocket-chip/src/main/scala/util/package.scala:242:49]
  wire [2:0]  dFirst_size_hi = auto_anon_out_d_bits_source[2:0] & {1'h1, _GEN[2:1]};	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :204:41, generators/rocket-chip/src/main/scala/util/package.scala:242:{47,49}, src/main/scala/chisel3/util/OneHot.scala:30:18]
  wire [2:0]  _dFirst_size_T_8 = {1'h0, dFirst_size_hi[2:1]} | ~(_dsizeOH1_T[2:0]) & {_GEN[0], _dsizeOH1_T[2:1]};	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, generators/rocket-chip/src/main/scala/util/package.scala:242:{47,49}, :244:{46,71,76}, src/main/scala/chisel3/util/OneHot.scala:30:18, :31:18, :32:28]
  ...
  wire [2:0]  aFragnum = aFirst ? ~(_aOrigOH1_T[5:3]) : gennum - 3'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:303:29, :304:29, :305:{30,79}, generators/rocket-chip/src/main/scala/util/package.scala:244:{46,71,76}]
  reg         aToggle_r;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:309:54]
  wire        _GEN_0 = ~_repeater_io_full | _repeater_io_deq_bits_opcode[2];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:92:37, generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30, :321:{17,35}]
  wire        _GEN_1 = ~_repeater_io_full | (&_repeater_io_deq_bits_mask);	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30, :321:17, :324:{35,53}]
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:214:16]
    always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:214:16]
      if ((`PRINTF_COND_) & ~reset & ~_GEN_0)	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:321:{16,35}]
      ...
      if ((`PRINTF_COND_) & ~reset & ~_GEN_1)	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:321:16, :324:{16,35}]
  ...
  `endif // not def SYNTHESIS
  wire        _GEN_2 = anonOut_d_ready & auto_anon_out_d_valid;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:235:35, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  wire        _GEN_3 = _GEN_2 & dFirst;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:202:24, :205:29, :220:27, :222:25, :223:19, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
    if (~reset) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:321:16, :324:16]
      assert__assert_1: assert(_GEN_0);	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:321:{16,35}]
      assert__assert_2: assert(_GEN_1);	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:324:{16,35}]
    end
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
      ...
      if (_GEN_3)	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:202:24, :220:27, :222:25, :223:19]
  ...
  Repeater_TLBundleA_a13d64s7k1z3u repeater (	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_anon_out_a_bits_address = {_repeater_io_deq_bits_address[12:6], _repeater_io_deq_bits_address[5:0] | {~(aFragnum | _aOrigOH1_T[5:3]), 3'h0}};	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :274:30, :305:30, :316:{49,51,88,111}, generators/rocket-chip/src/main/scala/util/package.scala:244:{71,76}]
