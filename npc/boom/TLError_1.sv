...
module TLError_1(	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9]
  ...
  wire            _GEN_0 = idle | ~r_counter;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:29:23, :34:18, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :231:25]
  ...
  wire            da_valid = auto_in_a_valid & idle;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:29:23, :36:35]
  ...
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:34:12]
    always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:34:12]
      if ((`PRINTF_COND_) & ~reset & ~_GEN_0)	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:34:{12,18}]
  ...
  wire            muxState_1 = beatsLeft ? state_1 : da_valid;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:36:35, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30, :88:26, :89:25]
  ...
  wire            nodeIn_d_valid = (~beatsLeft | state_1) & da_valid;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:36:35, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30, :61:28, :88:26, :96:24, src/main/scala/chisel3/util/Mux.scala:30:73]
  wire            nodeIn_d_bits_corrupt = muxState_1 & da_bits_opcode[0];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:38:21, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, src/main/scala/chisel3/util/Mux.scala:30:73]
  wire [1:0]      nodeIn_d_bits_size = {muxState_1, 1'h0};	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, src/main/scala/chisel3/util/Mux.scala:30:73]
  wire [2:0]      nodeIn_d_bits_opcode = muxState_1 ? da_bits_opcode : 3'h0;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:38:21, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, src/main/scala/chisel3/util/Mux.scala:30:73]
  wire            r_3 = da_ready & da_valid;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:36:35, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:94:31, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9]
    if (~reset)	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:34:12]
      assert__assert: assert(_GEN_0);	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:34:{12,18}]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9]
      ...
      beatsLeft <= ~(~beatsLeft & auto_in_d_ready) & beatsLeft - (auto_in_d_ready & nodeIn_d_valid);	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30, :61:28, :62:24, :85:{23,52}, :96:24, src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/chisel3/util/Mux.scala:30:73]
      if (beatsLeft) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30]
        ...
        state_1 <= da_valid;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:36:35, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:88:26]
    end
  end // always @(posedge)
  ...
  TLMonitor_46 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    ...
    .io_in_d_valid        (nodeIn_d_valid),	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:96:24, src/main/scala/chisel3/util/Mux.scala:30:73]
    .io_in_d_bits_opcode  (nodeIn_d_bits_opcode),	// @[src/main/scala/chisel3/util/Mux.scala:30:73]
    .io_in_d_bits_size    (nodeIn_d_bits_size),	// @[src/main/scala/chisel3/util/Mux.scala:30:73]
    .io_in_d_bits_denied  (muxState_1),	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25]
    .io_in_d_bits_corrupt (nodeIn_d_bits_corrupt)	// @[src/main/scala/chisel3/util/Mux.scala:30:73]
  ...
  assign auto_in_d_valid = nodeIn_d_valid;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:96:24, src/main/scala/chisel3/util/Mux.scala:30:73]
  assign auto_in_d_bits_opcode = nodeIn_d_bits_opcode;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9, src/main/scala/chisel3/util/Mux.scala:30:73]
  assign auto_in_d_bits_size = nodeIn_d_bits_size;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9, src/main/scala/chisel3/util/Mux.scala:30:73]
  ...
  assign auto_in_d_bits_corrupt = nodeIn_d_bits_corrupt;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9, src/main/scala/chisel3/util/Mux.scala:30:73]
endmodule
