...
module JtagBypassChain(	// @[generators/rocket-chip/src/main/scala/jtag/JtagShifter.scala:56:7]
  ...
  wire _GEN = ~(io_chainIn_capture & io_chainIn_update) & ~(io_chainIn_capture & io_chainIn_shift) & ~(io_chainIn_update & io_chainIn_shift);	// @[generators/rocket-chip/src/main/scala/jtag/JtagShifter.scala:72:{10,31}, :73:{7,10,31}, :74:{7,10,30}]
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/jtag/JtagShifter.scala:72:9]
    always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/jtag/JtagShifter.scala:72:9]
      if ((`PRINTF_COND_) & ~reset & ~_GEN)	// @[generators/rocket-chip/src/main/scala/jtag/JtagShifter.scala:72:9, :73:7, :74:7]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/jtag/JtagShifter.scala:56:7]
    if (~reset)	// @[generators/rocket-chip/src/main/scala/jtag/JtagShifter.scala:72:9]
      assert__assert: assert(_GEN);	// @[generators/rocket-chip/src/main/scala/jtag/JtagShifter.scala:72:9, :73:7, :74:7]
