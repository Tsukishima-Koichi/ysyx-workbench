...
module Queue2_TLBundleA_a32d64s3k3z3c(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  wire [116:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  ram_2x117 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_opcode, io_enq_bits_param, 3'h6, io_enq_bits_source, io_enq_bits_address, 73'h1FE0000000000000000})	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14, :256:91]
  ...
  assign io_deq_bits_opcode = _ram_ext_R0_data[116:114];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_param = _ram_ext_R0_data[113:111];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_size = _ram_ext_R0_data[110:108];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_source = _ram_ext_R0_data[107:105];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_address = _ram_ext_R0_data[104:73];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_mask = _ram_ext_R0_data[72:65];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = _ram_ext_R0_data[64:1];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
