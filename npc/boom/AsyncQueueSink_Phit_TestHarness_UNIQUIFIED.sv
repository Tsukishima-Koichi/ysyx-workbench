...
module AsyncQueueSink_Phit_TestHarness_UNIQUIFIED(	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:136:7]
  ...
  AsyncResetSynchronizerShiftReg_w4_d3_i0_TestHarness_UNIQUIFIED widx_widx_gray(	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
    .io_d  (io_async_widx),
    .io_q  (_widx_widx_gray_io_q)
  );	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:45:23]
  ClockCrossingReg_w32_TestHarness_UNIQUIFIED io_deq_bits_deq_bits_reg(	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25]
    .clock (clock),
  ...
  AsyncValidSync_TestHarness_UNIQUIFIED sink_valid_0(	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:172:33]
  ...
  AsyncValidSync_TestHarness_UNIQUIFIED sink_valid_1(	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:173:33]
  ...
  AsyncValidSync_TestHarness_UNIQUIFIED source_extend(	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:175:31]
  ...
  AsyncValidSync_TestHarness_UNIQUIFIED source_valid(	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:176:31]
