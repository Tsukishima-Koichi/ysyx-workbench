...
module FPUFMAPipe_l4_f64(	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
    ...
    if (io_in_valid) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:702:14]
      ...
      in_in2 <= io_in_bits_swap23 ? 33'h0 : io_in_bits_in2;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15, :714:8, :715:{23,32}]
      in_in3 <= io_in_bits_ren3 | io_in_bits_swap23 ? io_in_bits_in3 : 33'h0;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15, :714:8, :716:{21,37,46}]
    end
    if (_fma_io_validout) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:719:19]
      io_out_pipe_b_data <= _fma_io_out[32:0];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:719:19, src/main/scala/chisel3/util/Valid.scala:142:26]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
    ...
    logic [31:0] _RANDOM[0:5];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
    initial begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
        ...
        in_in1 = {_RANDOM[3'h0][31:29], _RANDOM[3'h1][29:0]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, :707:22, :708:15]
        in_in2 = {_RANDOM[3'h1][31:30], _RANDOM[3'h2][30:0]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, :708:15]
        in_in3 = {_RANDOM[3'h2][31], _RANDOM[3'h3]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, :708:15]
        io_out_pipe_v = _RANDOM[3'h4][0];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, src/main/scala/chisel3/util/Valid.scala:141:24]
        io_out_pipe_b_data = {_RANDOM[3'h4][31:1], _RANDOM[3'h5][1:0]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, src/main/scala/chisel3/util/Valid.scala:141:24, :142:26]
        io_out_pipe_b_exc = _RANDOM[3'h5][6:2];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, src/main/scala/chisel3/util/Valid.scala:142:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  MulAddRecFNPipe_l2_e11_s53 fma (	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:719:19]
    ...
    .io_a              ({32'h0, in_in1}),	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15, :724:12]
    .io_b              ({32'h0, in_in2}),	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15, :724:12, :725:12]
    .io_c              ({32'h0, in_in3}),	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15, :724:12, :726:12]
