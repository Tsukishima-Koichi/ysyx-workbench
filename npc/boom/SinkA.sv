...
module SinkA(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
  ...
  output [5:0]  io_req_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14]
  ...
  input  [5:0]  io_a_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14]
  ...
  wire        io_pb_pop_ready_0;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:106:40]
  ...
  wire [38:0] _freeOH_T_3 = _freeOH_T_22[38:0] | {_freeOH_T_22[37:0], 1'h0};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7, :59:25, generators/rocket-chip/src/main/scala/util/package.scala:254:{43,53}]
  wire [38:0] _freeOH_T_6 = _freeOH_T_3 | {_freeOH_T_3[36:0], 2'h0};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7, generators/rocket-chip/src/main/scala/util/package.scala:254:{43,53}]
  wire [38:0] _freeOH_T_9 = _freeOH_T_6 | {_freeOH_T_6[34:0], 4'h0};	// @[generators/rocket-chip/src/main/scala/util/package.scala:254:{43,48,53}]
  wire [38:0] _freeOH_T_12 = _freeOH_T_9 | {_freeOH_T_9[30:0], 8'h0};	// @[generators/rocket-chip/src/main/scala/util/package.scala:254:{43,53}]
  wire [38:0] _freeOH_T_15 = _freeOH_T_12 | {_freeOH_T_12[22:0], 16'h0};	// @[generators/rocket-chip/src/main/scala/util/package.scala:254:{43,48,53}]
  wire [39:0] _GEN = {~(_freeOH_T_15 | {_freeOH_T_15[6:0], 32'h0}), 1'h1} & _freeOH_T_22;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7, :59:{16,25,39}, generators/rocket-chip/src/main/scala/util/package.scala:254:{43,48,53}]
  ...
  wire        putbuffer_io_pop_valid = io_pb_pop_ready_0 & io_pb_pop_valid;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:106:40, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  wire [39:0] _io_pb_pop_ready_T = _putbuffer_io_valid >> io_pb_pop_bits_index;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:51:25, :106:40]
  assign io_pb_pop_ready_0 = _io_pb_pop_ready_T[0];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:106:40]
  wire [63:0] _lists_clr_T = 64'h1 << io_pb_pop_bits_index;	// @[src/main/scala/chisel3/util/OneHot.scala:65:12]
  wire [12:0] _first_beats1_decode_T = 13'h3F << io_a_bits_size;	// @[generators/rocket-chip/src/main/scala/util/package.scala:244:71]
  always @(posedge clock) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
    if (reset) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
      ...
      lists <= (lists | (_io_req_valid_T & ~(io_a_bits_opcode[2]) & ~req_block & ~buf_block ? _GEN : 40'h0)) & ~(putbuffer_io_pop_valid & io_pb_pop_bits_last ? _lists_clr_T[39:0] : 40'h0);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:52:22, :54:27, :55:27, :56:{19,32,34}, :59:39, :70:25, :71:27, :78:{14,28}, :79:27, :81:{26,37,51,66,78}, :109:{24,48}, :110:15, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:92:{28,37}, src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/chisel3/util/OneHot.scala:65:{12,27}]
      if (io_a_ready_0 & io_a_valid)	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:78:{25,39}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
        first_counter <= first ? (io_a_bits_opcode[2] ? 3'h0 : ~(_first_beats1_decode_T[5:3])) : first_counter - 3'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:92:37, :221:14, :229:27, :230:28, :231:25, :236:21, generators/rocket-chip/src/main/scala/util/package.scala:244:{46,71,76}]
    end
  ...
  assign io_req_bits_offset = io_a_bits_address[5:0];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:214:{21,47}, :217:50, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
  ...
  assign io_pb_pop_ready = io_pb_pop_ready_0;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7, :106:40]
endmodule
