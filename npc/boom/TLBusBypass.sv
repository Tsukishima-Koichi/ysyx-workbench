...
module TLBusBypass(	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:44:9]
  input         clock,	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:44:9]
  input         reset,	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:44:9]
  ...
  input         io_bypass	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:45:16]
);

  wire         _error_auto_in_a_ready;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:30:40]
  wire         _error_auto_in_d_valid;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:30:40]
  wire [2:0]   _error_auto_in_d_bits_opcode;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:30:40]
  wire [1:0]   _error_auto_in_d_bits_size;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:30:40]
  wire         _error_auto_in_d_bits_denied;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:30:40]
  wire         _error_auto_in_d_bits_corrupt;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:30:40]
  wire         _bar_auto_out_0_a_valid;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:20:33]
  wire [2:0]   _bar_auto_out_0_a_bits_opcode;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:20:33]
  wire [127:0] _bar_auto_out_0_a_bits_address;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:20:33]
  wire         _bar_auto_out_0_d_ready;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:20:33]
  TLBusBypassBar bar (	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:20:33]
    .clock                     (clock),
    .reset                     (reset),
    ...
    .auto_out_0_a_ready        (_error_auto_in_a_ready),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:30:40]
    ...
    .auto_out_0_d_valid        (_error_auto_in_d_valid),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:30:40]
    .auto_out_0_d_bits_opcode  (_error_auto_in_d_bits_opcode),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:30:40]
    .auto_out_0_d_bits_size    (_error_auto_in_d_bits_size),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:30:40]
    .auto_out_0_d_bits_denied  (_error_auto_in_d_bits_denied),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:30:40]
    .auto_out_0_d_bits_corrupt (_error_auto_in_d_bits_corrupt),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:30:40]
    .io_bypass                 (io_bypass)
  );	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:20:33]
  TLError_1 error (	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:30:40]
    .clock                  (clock),
    .reset                  (reset),
    .auto_in_a_ready        (_error_auto_in_a_ready),
    .auto_in_a_valid        (_bar_auto_out_0_a_valid),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:20:33]
    .auto_in_a_bits_opcode  (_bar_auto_out_0_a_bits_opcode),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:20:33]
    .auto_in_a_bits_address (_bar_auto_out_0_a_bits_address),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:20:33]
    .auto_in_d_ready        (_bar_auto_out_0_d_ready),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:20:33]
  ...
  );	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:30:40]
endmodule
