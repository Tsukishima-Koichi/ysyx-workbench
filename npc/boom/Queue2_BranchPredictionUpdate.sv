...
module Queue2_BranchPredictionUpdate(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  input          clock,	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  input          reset,	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  input          io_enq_valid,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input  [3:0]   io_enq_bits_btb_mispredicts,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output         io_deq_bits_is_mispredict_update,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output         io_deq_bits_is_repair_update,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output [3:0]   io_deq_bits_btb_mispredicts,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output         io_deq_bits_cfi_taken,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output         io_deq_bits_cfi_mispredicted,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output         io_deq_bits_cfi_is_br,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output         io_deq_bits_cfi_is_jal,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  ram_2x265 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({2'h0, io_enq_bits_btb_mispredicts, io_enq_bits_pc, 11'h0, io_enq_bits_ghist_old_history, 32'h0, io_enq_bits_meta_0})	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14, :256:91]
  ...
  assign io_deq_bits_is_mispredict_update = _ram_ext_R0_data[264];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_is_repair_update = _ram_ext_R0_data[263];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_btb_mispredicts = _ram_ext_R0_data[262:259];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_pc = _ram_ext_R0_data[258:227];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_br_mask = _ram_ext_R0_data[226:223];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cfi_idx_valid = _ram_ext_R0_data[222];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cfi_idx_bits = _ram_ext_R0_data[221:220];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cfi_taken = _ram_ext_R0_data[219];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cfi_mispredicted = _ram_ext_R0_data[218];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cfi_is_br = _ram_ext_R0_data[217];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cfi_is_jal = _ram_ext_R0_data[216];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_ghist_old_history = _ram_ext_R0_data[215:152];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_target = _ram_ext_R0_data[151:120];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_meta_0 = _ram_ext_R0_data[119:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
