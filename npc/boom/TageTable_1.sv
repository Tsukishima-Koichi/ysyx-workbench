...
module TageTable_1(	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:24:7]
  ...
  wire [6:0]  s1_hashed_idx = {io_f1_req_pc[9:7], io_f1_req_pc[6:3] ^ io_f1_req_ghist[3:0]};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:53:11, :60:{29,43}, generators/boom/src/main/scala/v3/ifu/frontend.scala:162:35]
  ...
  wire        doing_clear_u = clear_u_ctr[10:0] == 11'h0;	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:109:28, :112:{34,61}, :123:29]
  ...
  wire [3:0]  _GEN = io_update_pc[6:3] ^ io_update_hist[3:0];	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:53:11, :60:29, generators/boom/src/main/scala/v3/ifu/frontend.scala:162:35]
  wire [6:0]  update_idx = {io_update_pc[9:7], _GEN};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:60:{29,43}]
  wire [3:0]  _GEN_0 = io_update_pc[13:10] ^ io_update_hist[3:0];	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:53:11, :62:{30,50}, generators/boom/src/main/scala/v3/ifu/frontend.scala:162:35]
  wire [6:0]  update_tag = {io_update_pc[16:14], _GEN_0};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:62:{50,64}]
  assign table_MPORT_data_0 = doing_reset ? 11'h0 : {1'h1, io_update_pc[16:14], _GEN_0, update_wdata_0_ctr};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:62:{50,64}, :72:28, :123:{8,29,102}, :155:33]
  assign table_MPORT_data_1 = doing_reset ? 11'h0 : {1'h1, io_update_pc[16:14], _GEN_0, update_wdata_1_ctr};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:62:{50,64}, :72:28, :123:{8,29,102}, :155:33]
  assign table_MPORT_data_2 = doing_reset ? 11'h0 : {1'h1, io_update_pc[16:14], _GEN_0, update_wdata_2_ctr};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:62:{50,64}, :72:28, :123:{8,29,102}, :155:33]
  assign table_MPORT_data_3 = doing_reset ? 11'h0 : {1'h1, io_update_pc[16:14], _GEN_0, update_wdata_3_ctr};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:62:{50,64}, :72:28, :123:{8,29,102}, :155:33]
  wire [6:0]  _GEN_1 = {io_update_pc[9:7], _GEN};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:60:{29,43}, :129:36]
  ...
  always @(posedge clock) begin	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:24:7]
    ...
    s2_tag <= {io_f1_req_pc[16:14], io_f1_req_pc[13:10] ^ io_f1_req_ghist[3:0]};	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:53:11, :62:{30,50,64}, :95:29, generators/boom/src/main/scala/v3/ifu/frontend.scala:162:35]
  ...
  hi_us_0 hi_us (	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:89:27]
  ...
  lo_us_0 lo_us (	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:90:27]
    .R0_addr (s1_hashed_idx),	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:60:43]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
  ...
  table_0_0 table_0 (	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:91:27]
    .R0_addr (s1_hashed_idx),	// @[generators/boom/src/main/scala/v3/ifu/bpd/tage.scala:60:43]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
