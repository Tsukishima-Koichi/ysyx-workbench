...
module JtagTapController(	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:59:7]
  ...
  wire       tapIsInTestLogicReset = &_stateMachine_io_currState;	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:82:30, :120:38]
  ...
  always @(posedge clock_falling or posedge io_control_jtag_reset) begin	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:67:{33,48}]
    if (io_control_jtag_reset) begin	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:67:48]
      ...
      if (tapIsInTestLogicReset)	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:120:38]
        activeInstruction <= 5'h1;	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:111:36]
  ...
  assign io_output_tapIsInTestLogicReset = tapIsInTestLogicReset;	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:59:7, :120:38]
