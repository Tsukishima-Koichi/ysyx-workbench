...
module AsyncResetSynchronizerShiftReg_w4_d3_i0_TestHarness_UNIQUIFIED(	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:80:7]
  ...
  AsyncResetSynchronizerPrimitiveShiftReg_d3_i0_TestHarness_UNIQUIFIED output_chain(	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
  ...
  AsyncResetSynchronizerPrimitiveShiftReg_d3_i0_TestHarness_UNIQUIFIED output_chain_1(	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
    .io_d  (io_d[1]),	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:87:41]
    .io_q  (_output_chain_1_io_q)
  );	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:45:23]
  AsyncResetSynchronizerPrimitiveShiftReg_d3_i0_TestHarness_UNIQUIFIED output_chain_2(	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
    .io_d  (io_d[2]),	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:87:41]
    .io_q  (_output_chain_2_io_q)
  );	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:45:23]
  AsyncResetSynchronizerPrimitiveShiftReg_d3_i0_TestHarness_UNIQUIFIED output_chain_3(	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
