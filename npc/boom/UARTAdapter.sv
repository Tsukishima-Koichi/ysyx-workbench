...
module UARTAdapter(	// @[generators/testchipip/src/main/scala/uart/SimUART.scala:26:7]
  ...
  wire       _GEN = _txm_io_out_valid & ~reset;	// @[generators/testchipip/src/main/scala/uart/SimUART.scala:35:19, :48:35]
  `ifndef SYNTHESIS	// @[generators/testchipip/src/main/scala/uart/SimUART.scala:48:35]
    always @(posedge clock) begin	// @[generators/testchipip/src/main/scala/uart/SimUART.scala:48:35]
      if ((`PRINTF_COND_) & _GEN & ~_txq_io_enq_ready)	// @[generators/testchipip/src/main/scala/uart/SimUART.scala:36:19, :48:35]
  ...
  always @(posedge clock) begin	// @[generators/testchipip/src/main/scala/uart/SimUART.scala:48:35]
    if (_GEN)	// @[generators/testchipip/src/main/scala/uart/SimUART.scala:48:35]
      assert__assert: assert(_txq_io_enq_ready);	// @[generators/testchipip/src/main/scala/uart/SimUART.scala:36:19, :48:35]
  end // always @(posedge)
  SimUART #(
    .FORCEPTY(0),
    .UARTNO(0)
