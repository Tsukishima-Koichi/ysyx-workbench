...
module Queue1_FrontendResp(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  reg  [178:0] ram;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  always @(posedge clock) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    ...
    if (do_enq)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
      ram <= {io_enq_bits_pc, io_enq_bits_data, io_enq_bits_mask, io_enq_bits_xcpt_pf_inst, io_enq_bits_xcpt_gf_inst, io_enq_bits_xcpt_ae_inst, io_enq_bits_ghist_old_history, io_enq_bits_ghist_current_saw_branch_not_taken, io_enq_bits_ghist_new_saw_branch_not_taken, io_enq_bits_ghist_new_saw_branch_taken, io_enq_bits_ghist_ras_idx, io_enq_bits_fsrc, io_enq_bits_tsrc};	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    `ifdef FIRRTL_BEFORE_INITIAL	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
      `FIRRTL_BEFORE_INITIAL	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:5];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
        ...
        maybe_full = _RANDOM[3'h0][0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :259:27]
        ram = {_RANDOM[3'h0][31:1], _RANDOM[3'h1], _RANDOM[3'h2], _RANDOM[3'h3], _RANDOM[3'h4], _RANDOM[3'h5][19:0]};	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :259:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_deq_bits_pc = ram[178:147];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = ram[146:83];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_mask = ram[82:79];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_xcpt_pf_inst = ram[78];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_xcpt_ae_inst = ram[76];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_ghist_old_history = ram[75:12];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_ghist_current_saw_branch_not_taken = ram[11];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_ghist_new_saw_branch_not_taken = ram[10];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_ghist_new_saw_branch_taken = ram[9];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_ghist_ras_idx = ram[8:4];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_fsrc = ram[3:2];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_tsrc = ram[1:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
