...
module ErrorDeviceWrapper(	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:136:7]
  ...
  wire [6:0]  _error_auto_in_d_bits_source;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CanHaveBuiltInDevices.scala:40:29]
  ...
  TLBuffer_a14d64s7k1z4u buffer (	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:75:28]
    .clock                   (clock),
    .reset                   (reset),
