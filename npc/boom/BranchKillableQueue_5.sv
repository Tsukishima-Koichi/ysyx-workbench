...
module BranchKillableQueue_5(	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
  ...
  wire [3:0][7:0] _GEN_2 = {{uops_0_br_mask}, {uops_2_br_mask}, {uops_1_br_mask}, {uops_0_br_mask}};	// @[generators/boom/src/main/scala/v3/util/util.scala:466:20, :508:19]
  ...
  wire [3:0][4:0] _GEN_4 = {{uops_0_rob_idx}, {uops_2_rob_idx}, {uops_1_rob_idx}, {uops_0_rob_idx}};	// @[generators/boom/src/main/scala/v3/util/util.scala:466:20, :508:19]
  wire [3:0][2:0] _GEN_5 = {{uops_0_stq_idx}, {uops_2_stq_idx}, {uops_1_stq_idx}, {uops_0_stq_idx}};	// @[generators/boom/src/main/scala/v3/util/util.scala:466:20, :508:19]
  wire [3:0][5:0] _GEN_6 = {{uops_0_pdst}, {uops_2_pdst}, {uops_1_pdst}, {uops_0_pdst}};	// @[generators/boom/src/main/scala/v3/util/util.scala:466:20, :508:19]
  wire [3:0]      _GEN_7 = {{uops_0_is_amo}, {uops_2_is_amo}, {uops_1_is_amo}, {uops_0_is_amo}};	// @[generators/boom/src/main/scala/v3/util/util.scala:466:20, :508:19]
  wire [3:0]      _GEN_8 = {{uops_0_uses_stq}, {uops_2_uses_stq}, {uops_1_uses_stq}, {uops_0_uses_stq}};	// @[generators/boom/src/main/scala/v3/util/util.scala:466:20, :508:19]
  wire [3:0][1:0] _GEN_9 = {{uops_0_dst_rtype}, {uops_2_dst_rtype}, {uops_1_dst_rtype}, {uops_0_dst_rtype}};	// @[generators/boom/src/main/scala/v3/util/util.scala:466:20, :508:19]
  wire [3:0]      _GEN_10 = {{uops_0_fp_val}, {uops_2_fp_val}, {uops_1_fp_val}, {uops_0_fp_val}};	// @[generators/boom/src/main/scala/v3/util/util.scala:466:20, :508:19]
  ...
  wire            _GEN_11 = enq_ptr_value == 2'h0;	// @[generators/boom/src/main/scala/v3/util/util.scala:489:33, src/main/scala/chisel3/util/Counter.scala:61:40]
  ...
  wire            _GEN_13 = enq_ptr_value == 2'h1;	// @[generators/boom/src/main/scala/v3/util/util.scala:489:33, src/main/scala/chisel3/util/Counter.scala:61:40]
  ...
  wire            _GEN_15 = enq_ptr_value == 2'h2;	// @[generators/boom/src/main/scala/v3/util/util.scala:489:33, src/main/scala/chisel3/util/Counter.scala:61:40]
  ...
  always @(posedge clock) begin	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
    if (reset) begin	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
      ...
      valids_2 <= ~(do_deq & deq_ptr_value == 2'h2) & (_GEN_16 | valids_2 & (io_brupdate_b1_mispredict_mask & uops_2_br_mask) == 8'h0 & ~io_flush);	// @[generators/boom/src/main/scala/v3/util/util.scala:118:{51,59}, :465:24, :466:20, :476:{24,66}, :481:{16,29,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14, src/main/scala/chisel3/util/Counter.scala:61:40]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
    ...
    logic [31:0] _RANDOM[0:32];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
    initial begin	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
        ...
        uops_0_br_mask = _RANDOM[6'h4][31:24];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_rob_idx = _RANDOM[6'h6][19:15];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_stq_idx = _RANDOM[6'h6][25:23];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_pdst = {_RANDOM[6'h6][31:28], _RANDOM[6'h7][1:0]};	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_is_amo = _RANDOM[6'h9][14];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_uses_stq = _RANDOM[6'h9][16];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_dst_rtype = _RANDOM[6'hA][15:14];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_fp_val = _RANDOM[6'hA][21];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_uopc = _RANDOM[6'hB][6:0];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_br_mask = _RANDOM[6'hF][28:21];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_rob_idx = _RANDOM[6'h11][16:12];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_stq_idx = _RANDOM[6'h11][22:20];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_pdst = _RANDOM[6'h11][30:25];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_is_amo = _RANDOM[6'h14][11];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_uses_stq = _RANDOM[6'h14][13];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_dst_rtype = _RANDOM[6'h15][12:11];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_fp_val = _RANDOM[6'h15][18];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_uopc = {_RANDOM[6'h15][31:29], _RANDOM[6'h16][3:0]};	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_br_mask = _RANDOM[6'h1A][25:18];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_rob_idx = _RANDOM[6'h1C][13:9];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_stq_idx = _RANDOM[6'h1C][19:17];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_pdst = _RANDOM[6'h1C][27:22];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_is_amo = _RANDOM[6'h1F][8];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_uses_stq = _RANDOM[6'h1F][10];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_dst_rtype = _RANDOM[6'h20][9:8];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_fp_val = _RANDOM[6'h20][15];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        enq_ptr_value = _RANDOM[6'h20][27:26];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20, src/main/scala/chisel3/util/Counter.scala:61:40]
        deq_ptr_value = _RANDOM[6'h20][29:28];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20, src/main/scala/chisel3/util/Counter.scala:61:40]
        maybe_full = _RANDOM[6'h20][30];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20, :470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_3x45 ram_ext (	// @[generators/boom/src/main/scala/v3/util/util.scala:464:20]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_data, 12'h0})	// @[generators/boom/src/main/scala/v3/util/util.scala:464:20]
  ...
  assign io_deq_bits_fflags_valid = ~io_empty_0 & _ram_ext_R0_data[10];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_bits_uop_rob_idx = io_empty_0 ? 5'h0 : _ram_ext_R0_data[9:5];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :453:14, :464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_bits_flags = io_empty_0 ? 5'h0 : _ram_ext_R0_data[4:0];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :453:14, :464:20, :473:25, :510:27, :515:21, :517:19]
