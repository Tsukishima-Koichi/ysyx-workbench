...
module ram_2x104(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input          R0_addr,
  input          R0_en,
  input          R0_clk,
  ...
  reg [103:0] Memory[0:1];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [1:0] i = 2'h0; i < 2'h2; i += 2'h1) begin
          for (logic [7:0] j = 8'h0; j < 8'h80; j += 8'h20) begin
            _RANDOM_MEM[j[6:0] +: 32] = `RANDOM;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
          end
          Memory[i[0]] = _RANDOM_MEM[103:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 104'bx;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
endmodule
