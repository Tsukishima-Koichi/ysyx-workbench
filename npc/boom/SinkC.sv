...
module SinkC(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
  ...
  output [5:0]  io_req_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  ...
  output [5:0]  io_resp_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  ...
  input  [5:0]  io_c_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  ...
  wire        io_rel_pop_ready_0;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:161:43]
  ...
  wire [5:0]  _c_q_io_deq_bits_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire [12:0] _r_beats1_decode_T = 13'h3F << _c_q_io_deq_bits_size;	// @[generators/rocket-chip/src/main/scala/util/package.scala:244:71, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  wire [2:0]  r_beats1 = _c_q_io_deq_bits_opcode[0] ? ~(_r_beats1_decode_T[5:3]) : 3'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:102:36, :221:14, generators/rocket-chip/src/main/scala/util/package.scala:244:{46,71,76}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire        _bs_adr_valid_T = |r_counter;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :231:25]
  ...
  wire        _GEN = _c_q_io_deq_valid & _c_q_io_deq_bits_corrupt;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:90:23, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  `ifndef SYNTHESIS	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:90:12]
    always @(posedge clock) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:90:12]
      if ((`PRINTF_COND_) & ~reset & _GEN)	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:90:{12,23}]
  ...
  wire        bs_adr_valid = resp & (_bs_adr_valid_T | _c_q_io_deq_valid & _c_q_io_deq_bits_opcode[0]);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:79:19, :99:{30,41,53}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:102:36, :231:25, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire        req_block = ~_bs_adr_valid_T & ~io_req_ready;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:126:{27,30}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:231:25]
  ...
  wire        set_block = _c_q_io_deq_bits_opcode[0] & ~_bs_adr_valid_T & (&lists);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:116:24, :122:23, :128:{29,38}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:102:36, :231:25, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire [1:0]  put = _bs_adr_valid_T ? put_r : freeIdx;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:140:{18,44}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:231:25, src/main/scala/chisel3/util/OneHot.scala:32:10]
  wire        putbuffer_io_pop_valid = io_rel_pop_ready_0 & io_rel_pop_valid;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:161:43, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  wire [1:0]  _GEN_0 = {1'h0, io_rel_pop_bits_index[0]};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:161:{43,65}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:28]
  wire [1:0]  _io_rel_pop_ready_T_1 = _putbuffer_io_valid >> _GEN_0;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:115:27, :161:43]
  assign io_rel_pop_ready_0 = _io_rel_pop_ready_T_1[0];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:161:43]
  always @(posedge clock) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
    if (~reset)	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:90:12]
      assert__assert: assert(~_GEN);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:90:{12,13,23}]
    if (reset) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
      ...
      if (c_q_io_deq_ready & _c_q_io_deq_valid)	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:134:19, src/main/scala/chisel3/util/Decoupled.scala:51:35, :362:21]
        r_counter <= _bs_adr_valid_T ? _r_counter1_T : r_beats1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :230:28, :231:25, :236:21]
      lists <= (lists | (~resp & _c_q_io_deq_valid & ~_bs_adr_valid_T & _c_q_io_deq_bits_opcode[0] & ~req_block & ~buf_block ? freeIdx_lo : 2'h0)) & ~(putbuffer_io_pop_valid & io_rel_pop_bits_last ? 2'h1 << _GEN_0 : 2'h0);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :79:19, :116:24, :118:29, :119:29, :120:{21,34,36}, :123:41, :126:27, :127:29, :134:{56,70}, :136:21, :138:{17,28,37,48,62,77,89}, :161:43, :164:{27,52}, :165:17, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:102:36, :231:25, src/main/scala/chisel3/util/Decoupled.scala:51:35, :362:21, src/main/scala/chisel3/util/OneHot.scala:65:12]
    end
    ...
    if (~_bs_adr_valid_T)	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:231:25]
  ...
  Queue2_TLBundleC_a32d64s6k3z3c c_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  ListBuffer_PutBufferCEntry_q2_e16 putbuffer (	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:115:27]
    ...
    .io_push_bits_index        (put[0]),	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:140:18, :154:34]
    ...
    .io_pop_bits               (io_rel_pop_bits_index[0]),	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:159:27]
  ...
  assign io_req_valid = ~resp & _c_q_io_deq_valid & ~_bs_adr_valid_T & ~buf_block & ~set_block;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :79:19, :127:29, :128:{29,38}, :134:{70,84}, :136:{21,27,38,47,61}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:231:25, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  assign io_req_bits_offset = _c_q_io_deq_bits_address[5:0];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:214:{21,47}, :217:50, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  assign io_req_bits_put = {4'h0, put};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :140:18, :152:36]
  ...
  assign io_resp_valid = resp & _c_q_io_deq_valid & (~_bs_adr_valid_T | last) & (~(_c_q_io_deq_bits_opcode[0]) | _io_bs_adr_q_io_enq_ready);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :79:19, :107:{27,38,48,57,61,70}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:102:36, :231:25, :232:33, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  assign io_rel_pop_ready = io_rel_pop_ready_0;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :161:43]
endmodule
