...
module Repeater_TLBundleD_a32d64s1k3z4u(	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
  ...
  input  [2:0]  io_enq_bits_sink,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  ...
  output [2:0]  io_deq_bits_sink,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  ...
  reg  [2:0]  saved_sink;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:21:18]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
        ...
        saved_sink = _RANDOM[2'h0][13:11];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_denied = _RANDOM[2'h0][14];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_data = {_RANDOM[2'h0][31:15], _RANDOM[2'h1], _RANDOM[2'h2][14:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_corrupt = _RANDOM[2'h2][15];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
