...
module TLFragmenter_bootrom(	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
  ...
  wire        _GEN_0 = ~_repeater_io_full | (&_repeater_io_deq_bits_mask);	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30, :321:17, :324:{35,53}]
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:214:16]
    always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:214:16]
      if ((`PRINTF_COND_) & ~reset & ~_GEN_0)	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:324:{16,35}]
  ...
  `endif // not def SYNTHESIS
  wire        _GEN_1 = auto_anon_in_d_ready & auto_anon_out_d_valid;	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
  wire        _GEN_2 = _GEN_1 & dFirst;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:202:24, :205:29, :220:27, :222:25, :223:19, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
    if (~reset)	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:324:16]
      assert__assert_2: assert(_GEN_0);	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:324:{16,35}]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
      ...
      if (_GEN_2)	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:202:24, :220:27, :222:25, :223:19]
  ...
  assign auto_anon_out_a_bits_address = {_repeater_io_deq_bits_address[16:6], _repeater_io_deq_bits_address[5:0] | {~(aFragnum | _aOrigOH1_T[5:3]), 3'h0}};	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :274:30, :305:30, :316:{49,51,88,111}, generators/rocket-chip/src/main/scala/util/package.scala:244:{71,76}]
