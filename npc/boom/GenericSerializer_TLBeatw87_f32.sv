...
module GenericSerializer_TLBeatw87_f32(	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7]
  ...
  wire       io_out_valid_0 = |beat;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:20:21, :23:{31,39}]
  always @(posedge clock) begin	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7]
    ...
    else if (io_out_ready & io_out_valid_0)	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:23:{31,39}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  assign io_out_valid = io_out_valid_0;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7, :23:{31,39}]
  assign io_out_bits_flit = beat == 2'h0 ? {30'h0, io_in_bits_head, io_in_bits_tail} : 32'h0;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7, :20:21, :22:39, :24:{26,52}]
endmodule
