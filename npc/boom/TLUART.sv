...
module TLUART(	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25]
  ...
  wire             _out_out_bits_data_T_1 = auto_control_xing_in_a_bits_address[11:5] == 7'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  ...
  wire [3:0]       _out_backSel_T = 4'h1 << auto_control_xing_in_a_bits_address[4:3];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:192:34, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:75:19, :87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  assign out_backSel_0 = _out_backSel_T[0];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  wire             _out_wofireMux_T_2 = _out_wofireMux_T & auto_control_xing_in_a_bits_opcode != 3'h4;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:74:36, :87:24]
  assign out_woready_2 = _out_wofireMux_T_2 & out_backSel_0 & _out_out_bits_data_T_1;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             out_woready_9 = _out_wofireMux_T_2 & _out_backSel_T[1] & _out_out_bits_data_T_1;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  wire             out_woready_12 = _out_wofireMux_T_2 & _out_backSel_T[2] & _out_out_bits_data_T_1;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25]
    if (reset) begin	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25]
      ...
      if (_out_wofireMux_T_2 & _out_backSel_T[3] & _out_out_bits_data_T_1 & (&{{8{auto_control_xing_in_a_bits_mask[1]}}, {8{auto_control_xing_in_a_bits_mask[0]}}}))	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  Queue8_UInt8 rxq (	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:133:19]
    ...
    .io_deq_ready (_out_wofireMux_T & in_bits_read & out_backSel_0 & _out_out_bits_data_T_1 & auto_control_xing_in_a_bits_mask[4]),	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:74:36, :87:24]
  ...
  assign auto_control_xing_in_d_bits_data = _out_out_bits_data_T_1 ? _GEN[auto_control_xing_in_a_bits_address[4:3]] : 64'h0;	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:192:34, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:75:19, :87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
endmodule
