...
module SBToTL(	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
  ...
  wire            _GEN_0 = |(io_addrIn[127:13]);	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{41,46,59}]
  wire            _GEN_1 = |{io_addrIn[127:14], ~(io_addrIn[13:12])};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46,59}]
  wire            _GEN_2 = |{io_addrIn[127:21], io_addrIn[20:17] ^ 4'h8, io_addrIn[15:12]};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46,59}]
  wire            _GEN_3 = |{io_addrIn[127:26], io_addrIn[25:16] ^ 10'h200};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46,59}]
  wire            _GEN_4 = |{io_addrIn[127:26], io_addrIn[25:12] ^ 14'h2010};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46,59}]
  wire            _GEN_5 = |{io_addrIn[127:28], io_addrIn[27:16] ^ 12'h800};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46,59}]
  wire            _GEN_6 = |{io_addrIn[127:28], ~(io_addrIn[27:26])};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46,59}]
  wire            _GEN_7 = |{io_addrIn[127:29], io_addrIn[28:12] ^ 17'h10020};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46,59}]
  wire            _GEN_8 = |{io_addrIn[127:32], io_addrIn[31:28] ^ 4'h8};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46,59}]
  wire            io_rdLegal_0 = ~_GEN_0 | ~_GEN_1 | {io_addrIn[127:17], ~(io_addrIn[16])} == 112'h0 | ~_GEN_2 | ~_GEN_3 | ~_GEN_4 | ~_GEN_5 | ~_GEN_6 | ~_GEN_7 | ~_GEN_8;	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
  wire            io_wrLegal_0 = ~_GEN_0 | ~_GEN_1 | ~_GEN_2 | ~_GEN_3 | ~_GEN_4 | ~_GEN_5 | ~_GEN_6 | ~_GEN_7 | ~_GEN_8;	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
  ...
  wire            _GEN_9 = sbState == 3'h0;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26, :349:19]
  ...
  wire            _GEN_10 = _GEN_9 | _nodeOut_a_valid_T | _nodeOut_a_valid_T_1 | _rdTxValid_T | _io_wrDone_T;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:299:{25,62}, :322:18, :338:29, :349:19, :373:35, :374:44, :375:45, :376:45]
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:373:12]
    always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:373:12]
      if ((`PRINTF_COND_) & ~reset & ~_GEN_10)	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:373:{12,35}, :374:44, :375:45, :376:45]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
    if (~reset)	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:373:12]
      assert__assert: assert(_GEN_10);	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:373:{12,35}, :374:44, :375:45, :376:45]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
      ...
      if (_GEN_9) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:349:19]
  ...
  assign auto_out_a_bits_address = io_addrIn[31:0];	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:465:15]
