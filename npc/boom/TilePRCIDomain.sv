...
module TilePRCIDomain(	// @[generators/rocket-chip/src/main/scala/prci/ClockDomain.scala:14:9]
  ...
  input         auto_element_reset_domain_boom_tile_hartid_in,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  output [2:0]  auto_tl_master_clock_xing_out_a_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  output [2:0]  auto_tl_master_clock_xing_out_c_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  input  [2:0]  auto_tl_master_clock_xing_out_d_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  wire        _element_reset_domain_boom_tile_auto_buffer_out_a_valid;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire [2:0]  _element_reset_domain_boom_tile_auto_buffer_out_a_bits_opcode;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire [2:0]  _element_reset_domain_boom_tile_auto_buffer_out_a_bits_param;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire [3:0]  _element_reset_domain_boom_tile_auto_buffer_out_a_bits_size;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire [2:0]  _element_reset_domain_boom_tile_auto_buffer_out_a_bits_source;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire [31:0] _element_reset_domain_boom_tile_auto_buffer_out_a_bits_address;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire [7:0]  _element_reset_domain_boom_tile_auto_buffer_out_a_bits_mask;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire [63:0] _element_reset_domain_boom_tile_auto_buffer_out_a_bits_data;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire        _element_reset_domain_boom_tile_auto_buffer_out_b_ready;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire        _element_reset_domain_boom_tile_auto_buffer_out_c_valid;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire [2:0]  _element_reset_domain_boom_tile_auto_buffer_out_c_bits_opcode;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire [2:0]  _element_reset_domain_boom_tile_auto_buffer_out_c_bits_param;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire [3:0]  _element_reset_domain_boom_tile_auto_buffer_out_c_bits_size;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire [2:0]  _element_reset_domain_boom_tile_auto_buffer_out_c_bits_source;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire [31:0] _element_reset_domain_boom_tile_auto_buffer_out_c_bits_address;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire [63:0] _element_reset_domain_boom_tile_auto_buffer_out_c_bits_data;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire        _element_reset_domain_boom_tile_auto_buffer_out_d_ready;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire        _element_reset_domain_boom_tile_auto_buffer_out_e_valid;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire [2:0]  _element_reset_domain_boom_tile_auto_buffer_out_e_bits_sink;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  BoomTile element_reset_domain_boom_tile (	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  ...
  TLBuffer_a32d64s3k3z4c_1 buffer (	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:75:28]
    .clock                   (auto_tap_clock_in_clock),
    .reset                   (auto_tap_clock_in_reset),
    .auto_in_a_ready         (_buffer_auto_in_a_ready),
    .auto_in_a_valid         (_element_reset_domain_boom_tile_auto_buffer_out_a_valid),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_a_bits_opcode   (_element_reset_domain_boom_tile_auto_buffer_out_a_bits_opcode),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_a_bits_param    (_element_reset_domain_boom_tile_auto_buffer_out_a_bits_param),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_a_bits_size     (_element_reset_domain_boom_tile_auto_buffer_out_a_bits_size),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_a_bits_source   (_element_reset_domain_boom_tile_auto_buffer_out_a_bits_source),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_a_bits_address  (_element_reset_domain_boom_tile_auto_buffer_out_a_bits_address),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_a_bits_mask     (_element_reset_domain_boom_tile_auto_buffer_out_a_bits_mask),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_a_bits_data     (_element_reset_domain_boom_tile_auto_buffer_out_a_bits_data),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_b_ready         (_element_reset_domain_boom_tile_auto_buffer_out_b_ready),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    ...
    .auto_in_c_valid         (_element_reset_domain_boom_tile_auto_buffer_out_c_valid),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_c_bits_opcode   (_element_reset_domain_boom_tile_auto_buffer_out_c_bits_opcode),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_c_bits_param    (_element_reset_domain_boom_tile_auto_buffer_out_c_bits_param),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_c_bits_size     (_element_reset_domain_boom_tile_auto_buffer_out_c_bits_size),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_c_bits_source   (_element_reset_domain_boom_tile_auto_buffer_out_c_bits_source),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_c_bits_address  (_element_reset_domain_boom_tile_auto_buffer_out_c_bits_address),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_c_bits_data     (_element_reset_domain_boom_tile_auto_buffer_out_c_bits_data),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_d_ready         (_element_reset_domain_boom_tile_auto_buffer_out_d_ready),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    ...
    .auto_in_e_valid         (_element_reset_domain_boom_tile_auto_buffer_out_e_valid),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
    .auto_in_e_bits_sink     (_element_reset_domain_boom_tile_auto_buffer_out_e_bits_sink),	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
