...
module head_21x6(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/ListBuffer.scala:48:18]
  input  [4:0] R0_addr,
  input        R0_en,
  input        R0_clk,
  output [5:0] R0_data,
  ...
  reg [5:0] Memory[0:20];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/ListBuffer.scala:48:18]
