...
module SinkD(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
  ...
  wire [12:0] _r_beats1_decode_T = 13'h3F << _d_q_io_deq_bits_size;	// @[generators/rocket-chip/src/main/scala/util/package.scala:244:71, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  wire [2:0]  r_beats1 = _d_q_io_deq_bits_opcode[0] ? ~(_r_beats1_decode_T[5:3]) : 3'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, :221:14, generators/rocket-chip/src/main/scala/util/package.scala:244:{46,71,76}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire        _io_bs_adr_valid_T = |r_counter;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :231:25]
  ...
  assign d_q_io_deq_ready = io_bs_adr_ready & (_io_bs_adr_valid_T | io_grant_safe);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:63:{30,41}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:231:25]
  reg  [2:0]  io_bs_adr_bits_beat_r;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:78:54]
  wire        _GEN = _d_q_io_deq_valid & _d_q_io_deq_bits_corrupt & ~_d_q_io_deq_bits_denied;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:82:{21,39,42}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  `ifndef SYNTHESIS	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:82:10]
    always @(posedge clock) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:82:10]
      if ((`PRINTF_COND_) & ~reset & _GEN)	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:82:{10,21,39}]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
    if (~reset)	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:82:10]
      assert__assert: assert(~_GEN);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:82:{10,11,21,39}]
    if (reset)	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
      ...
      r_counter <= _io_bs_adr_valid_T ? _r_counter1_T : r_beats1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :230:28, :231:25, :236:21]
  ...
  assign io_resp_valid = (~_io_bs_adr_valid_T | last) & _io_resp_valid_T_1;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7, :62:{27,36}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:231:25, :232:33, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  assign io_bs_adr_valid = _io_bs_adr_valid_T | _d_q_io_deq_valid & io_grant_safe;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7, :64:{29,41}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:231:25, src/main/scala/chisel3/util/Decoupled.scala:362:21]
