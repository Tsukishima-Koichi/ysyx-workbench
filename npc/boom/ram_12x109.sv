...
module ram_12x109(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input  [3:0]   R0_addr,
  input          R0_en,
  input          R0_clk,
  ...
  reg [108:0] Memory[0:11];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [3:0] i = 4'h0; i < 4'hC; i += 4'h1) begin
          ...
          Memory[i] = _RANDOM_MEM[108:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 109'bx;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
endmodule
