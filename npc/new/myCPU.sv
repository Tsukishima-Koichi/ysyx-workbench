...
module myCPU (
    ...
    logic [31:0] mem1_fw_data, mem1_pipe_fw_data, mem1_exec_res;
    ...
    // Use the multiplier output register directly as the MEM1 result register.
    assign mem1_exec_res = mem1_is_M ? mdu_res : mem1_alu_res;
    assign mem1_fw_data  = mem1_is_M ? mdu_res : mem1_pipe_fw_data;
