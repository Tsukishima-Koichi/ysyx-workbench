...
module MDU (
    ...
    // The product is captured on the same edge that advances its metadata to
    // MEM1. MEM1 then consumes this registered result, so MUL stalls once.
    assign done = op_is_div ? div_done : (mul_state == 2'b01);
