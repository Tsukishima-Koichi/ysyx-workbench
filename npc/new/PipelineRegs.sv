...
module MEM1_MEM2_Reg #(parameter DATAWIDTH = 32)(
    ...
    (* DONT_TOUCH = "TRUE" *) logic [DATAWIDTH-1:0] r_mem2_load_data;
    (* DONT_TOUCH = "TRUE" *) logic [DATAWIDTH-1:0] r_mem2_load_fwd_data;
    assign mem2_load_data     = r_mem2_load_data;
    assign mem2_load_fwd_data = r_mem2_load_fwd_data;
    ...
    always_ff @(posedge clk) begin
        if (!stall) begin
            ...
            r_mem2_load_fwd_data <= mem1_perip_rdata;
        end
    end
endmodule
