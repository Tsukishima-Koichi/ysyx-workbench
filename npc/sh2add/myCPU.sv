...
module myCPU (
    ...
    logic [4:0]  mem1_rd;
    logic        mem1_RegWen, mem1_MemWen, mem1_is_M;
    logic [1:0]  mem1_WbSel;
    logic [2:0]  mem1_funct3;
    logic [31:0] mem1_ex_fw_data, mem1_pipe_fw_data;
    logic [31:0] mem1_exec_res, mem1_to_mem2_fw_data;
    ...
    logic stall_req_mdu, stall_req_mem_port, stall_req_mdu_dependency;
    ...
    // Let a completed MDU instruction advance, but keep an immediately
    // dependent consumer in ID until the result reaches the MEM2 registers.
    assign stall_req_mdu_dependency =
        id_valid & ex_valid & ex_is_M & mdu_done & ex_RegWen & (ex_rd != 5'd0) &
        ((id_rs1_read & (id_inst[19:15] == ex_rd)) |
         (id_rs2_read & (id_inst[24:20] == ex_rd)));

    // 🌟 修改：Load-Use 和 MDU 除法冲突时，所有前级全部停顿
    assign stall_IF1 = hd_stall_IF | stall_req_ex_hold | stall_req_mdu_dependency;
    assign stall_IF2 = hd_stall_IF | stall_req_ex_hold | stall_req_mdu_dependency;
    assign stall_ID  = hd_stall_ID | stall_req_ex_hold | stall_req_mdu_dependency;
    ...
    always_comb begin
        case (id_forward_A)
            2'b10:   id_agu_base = mem1_ex_fw_data;
    ...
    always_comb begin
        case (ex_forward_A)
            2'b11:   fwd_rs1_comb = mem1_ex_fw_data;
        ...
        endcase
        case (ex_forward_B)
            2'b11:   fwd_rs2_comb = mem1_ex_fw_data;
    ...
    // MDU data may enter MEM2, but it must not feed an EX consumer directly
    // from MEM1. The dependency interlock above guarantees that such a
    // consumer waits one cycle and then uses the regular MEM2 forwarding path.
    assign mem1_exec_res        = mem1_is_M ? mdu_res : mem1_alu_res;
    assign mem1_to_mem2_fw_data = mem1_is_M ? mdu_res : mem1_pipe_fw_data;
    assign mem1_ex_fw_data      = mem1_pipe_fw_data;
    ...
    EX_MEM1_Reg #(DATAWIDTH) ex_mem1_reg (
        ...
        .ex_rd(ex_rd), .ex_RegWen(ex_RegWen), .ex_MemWen(ex_MemWen), .ex_is_M(ex_is_M),
        ...
        .mem1_rd(mem1_rd), .mem1_RegWen(mem1_RegWen), .mem1_MemWen(mem1_MemWen), .mem1_is_M(mem1_is_M),
    ...
    MEM1_MEM2_Reg #(DATAWIDTH) mem1_mem2_reg (
        ...
        .mem1_alu_res(mem1_exec_res), .mem1_agu_res(mem1_agu_res), .mem1_ret_pc(mem1_ret_pc), .mem1_csr_rdata(mem1_csr_rdata),
        .mem1_rd(mem1_rd), .mem1_RegWen(mem1_RegWen), .mem1_WbSel(mem1_WbSel), .mem1_funct3(mem1_funct3),
        .mem1_fw_data(mem1_to_mem2_fw_data),
...
`ifdef NPC_TEST
    ...
    perf_counters u_perf (
        ...
        .stall_req_mdu           (stall_req_mdu | stall_req_mdu_dependency),
